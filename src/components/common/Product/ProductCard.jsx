import { Button, Card, CardActions, CardContent, CardMedia, Grid, Rating, Typography } from "@material-ui/core";
	...
	return (
		<Card className={classes.root} onClick={() => history.push(PRODUCT_ROUTE + "/" + id)} sx={{ p: 2 }}>
			<Grid container spacing="5" justifyContent="space-between">
				<Grid item xs={3}>
					<CardMedia className={classes.image} component="img" alt="card_image" src={img} />
				</Grid>
				<Grid item xs={6}>
					<CardContent
						sx={{
