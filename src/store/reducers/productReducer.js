import { RESET_CATEGORY, SELECT_CATEGORY, SET_CATEGORIES, SET_PRODUCTS, SET_SORT_ORDER, SET_SORT_TYPE, SET_SAERCH_VALUE, CLEAR_SEARCH } from "../actions/types"
...
const initialState = {
    products: [
        ...
        {id: 3, name: 'Мышь', price: 1000, category: 'Перифирия', rate: 4.2, img: 'https://media.istockphoto.com/photos/green-gaming-mouse-on-stone-texture-table-picture-id1197265704?b=1&k=20&m=1197265704&s=170667a&w=0&h=SVAlwsKsBLgtHEBY7jOveT9C6gLaKX6RLJzqbzzmEwo='},
...
export const productReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case CLEAR_SEARCH: return {...state, searchValue: ''}
        case SET_SAERCH_VALUE: return {...state, searchValue: action.payload}
